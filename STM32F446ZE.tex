...
%-Pins der Spannungsversorgung\\
%\hspace*{5mm}-(globaler Puffer-Kondensator)\\
%\hspace*{5mm}-VDDA und VREF\\
%\hspace*{5mm}-Kein USB-Bootloader (sowieso besser, da mehr Speicherplatz zur Verfügung steht)\\
%\hspace*{5mm}-Boot0 (inkl. Beschaltung)\\
%\hspace*{5mm}-NRST (inkl. Beschaltung)\\